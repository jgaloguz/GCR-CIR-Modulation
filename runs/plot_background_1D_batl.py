...
if plot_den:
   ...
   for direction in directions:
      Z = np.loadtxt("output_{:s}/CIR/den_{:s}_{:s}.dat".format(cir_date, direction, cir_date))
   ...
   plt.savefig("output_{:s}/CIR/den_cuts_{:s}.png".format(cir_date, cir_date), dpi=200)
   plt.close()
...
if plot_tmp:
   ...
   n = np.loadtxt("output_{:s}/CIR/den_1au_{:s}.dat".format(cir_date, cir_date))
   ...
   plt.savefig("output_{:s}/CIR/tmp_1au_{:s}.png".format(cir_date, cir_date), dpi=200)
   plt.close()

   for direction in directions:
      Z = np.loadtxt("output_{:s}/CIR/pth_{:s}_{:s}.dat".format(cir_date, direction, cir_date))
      P = np.copy(Z)
      P[:,1] = P[:,1] * 0.1 # dyn/cm^2 --> Pa
      n = np.loadtxt("output_{:s}/CIR/den_{:s}_{:s}.dat".format(cir_date, direction, cir_date))
      n[:,1] = n[:,1] * 1.0e6 # cm^-3 --> m^-3
      Z[:,1] = P[:,1] / n[:,1] / 1.380649e-23 / 1.0e6 # T = P / (n*k_B) and K --> MK
      Z[:,0] = P[:,0]
      plt.loglog(Z[:,0], Z[:,1], label=direction)
   ...
   plt.savefig("output_{:s}/CIR/tmp_cuts_{:s}.png".format(cir_date, cir_date), dpi=200)
   plt.close()
...
if plot_vel:
   ...
   for direction in directions:
      Z = np.loadtxt("output_{:s}/CIR/vel_{:s}_{:s}.dat".format(cir_date, direction, cir_date))
      Z[:,1] = Z[:,1] / 1.0e5 # cm/s --> km/s
   ...
   plt.savefig("output_{:s}/CIR/vel_cuts_{:s}.png".format(cir_date, cir_date), dpi=200)
   plt.close()
...
if plot_rad_vel:
   ...
   for direction in directions:
      Z = np.loadtxt("output_{:s}/CIR/rad_vel_{:s}_{:s}.dat".format(cir_date, direction, cir_date))
      plt.semilogx(Z[:,0], Z[:,1], label=direction)
   ...
   plt.savefig("output_{:s}/CIR/rad_vel_cuts_{:s}.png".format(cir_date, cir_date), dpi=200)
   plt.close()
...
if plot_div_vel:
   ...
   for direction in directions:
      Z = np.loadtxt("output_{:s}/CIR/div_vel_{:s}_{:s}.dat".format(cir_date, direction, cir_date))
      plt.loglog(Z[:,0], Z[:,1], label=direction)
   ...
   plt.savefig("output_{:s}/CIR/div_vel_cuts_{:s}.png".format(cir_date, cir_date), dpi=200)
   plt.close()
...
if plot_mag:
   ...
   for direction in directions:
      Z = np.loadtxt("output_{:s}/CIR/mag_{:s}_{:s}.dat".format(cir_date, direction, cir_date))
      Z[:,1] = Z[:,1] / 1.0e-5 # G --> nT
      plt.loglog(Z[:,0], Z[:,1], label=direction)
   ...
   plt.savefig("output_{:s}/CIR/mag_cuts_{:s}.png".format(cir_date, cir_date), dpi=200)
   plt.close()
...
if plot_pol:
   ...
   for direction in directions:
      Z = np.loadtxt("output_{:s}/CIR/pol_{:s}_{:s}.dat".format(cir_date, direction, cir_date))
      plt.semilogx(Z[:,0], Z[:,1], label=direction)
   ...
   plt.savefig("output_{:s}/CIR/pol_cuts_{:s}.png".format(cir_date, cir_date), dpi=200)
   plt.close()
...
if plot_dmax:
   ...
   for direction in directions:
      Z = np.loadtxt("output_{:s}/CIR/dmax_{:s}_{:s}.dat".format(cir_date, direction, cir_date))
      plt.semilogx(Z[:,0], Z[:,1], label=direction)
   plt.title('Cell Size')
   plt.xlabel('r (au)')
   plt.ylabel('$\\Delta x$ (au)')
   ...
   plt.savefig("output_{:s}/CIR/dmax_cuts_{:s}.png".format(cir_date, cir_date), dpi=200)
   plt.close()
...
if plot_het_flx:
   ...
   for direction in directions:
      Z = np.loadtxt("output_{:s}/CIR/het_flx_{:s}_{:s}.dat".format(cir_date, direction, cir_date))
      plt.loglog(Z[:,0], Z[:,1], label=direction)
   plt.title('Heat Flux')
   plt.xlabel('r (au)')
   plt.ylabel('$Q_e$ (cm$^2$ s$^{-2}$)')
   ...
   plt.savefig("output_{:s}/CIR/het_flx_cuts_{:s}.png".format(cir_date, cir_date), dpi=200)
   plt.close()
...
if plot_tur_enr:
   ...
   for direction in directions:
      Z = np.loadtxt("output_{:s}/CIR/tur_enr_{:s}_{:s}.dat".format(cir_date, direction, cir_date))
      plt.loglog(Z[:,0], Z[:,1], label=direction)
   ...
   plt.savefig("output_{:s}/CIR/tur_enr_cuts_{:s}.png".format(cir_date, cir_date), dpi=200)
   plt.close()
...
if plot_drift:
   ...
   for direction in directions:
      Z = np.loadtxt("output_{:s}/CIR/drift_{:s}_{:s}.dat".format(cir_date, direction, cir_date))
      plt.semilogx(Z[:,0], Z[:,1], label=direction)
   ...
   plt.savefig("output_{:s}/CIR/drift_cuts_{:s}.png".format(cir_date, cir_date), dpi=200)
   plt.close()
...
if plot_diff1:
   ...
   for direction in directions:
      Z = np.loadtxt("output_{:s}/CIR/diff1_{:s}_{:s}.dat".format(cir_date, direction, cir_date))
      plt.loglog(Z[:,0], Z[:,1], label=direction)
   ...
   plt.savefig("output_{:s}/CIR/diff1_cuts_{:s}.png".format(cir_date, cir_date), dpi=200)
   plt.close()
...
if plot_diff2:
   ...
   for direction in directions:
      Z = np.loadtxt("output_{:s}/CIR/diff2_{:s}_{:s}.dat".format(cir_date, direction, cir_date))
      plt.loglog(Z[:,0], Z[:,1], label=direction)
   ...
   plt.savefig("output_{:s}/CIR/diff2_cuts_{:s}.png".format(cir_date, cir_date), dpi=200)
   plt.close()
